...
const Test = ({ selectedColor, onChange }) => {
  const colors = [
  ...
  return (
    <div className='flex justify-center items-center relative h-full'>
      ...
      {isOpen && (
        <div className='grid grid-cols-4 w-60 gap-2 absolute top-full left-1/2 -translate-x-1/2 p-3 mt-2 z-10 bg-white rounded-md border border-gray-200 shadow-sm'>
          {colors.map((color) => (
            <div
              key={color.value}
